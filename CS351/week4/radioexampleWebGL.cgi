...
<form id="newexampleForm2">

</form>

</td>
<td colspan = 2>
 <input type="button" id="mybutton2" onClick="doclickrun()" value="Display Output">
</td>
</tr>
...
<form id="exampleForm">
 ...
 <input type="button" id="mybutton" onClick="doclicktestcase()" value="Run Testcase">
</form>
</td>
</tr>
...
function sendRequest1(theTestCase) { 
  ...
  // exampleWebGL2 fixes an off by 1 problem.
  alert('SENDREQ1:' + 'http://localhost:55555/cgi-bin/exampleWebGL2.cgi?myfunc=execexample&exampleTestCase=' + theTestCase);
  http.open('get', 'http://localhost:55555/cgi-bin/exampleWebGL2.cgi?myfunc=execexample&exampleTestCase=' + theTestCase + '&nocache='+now.getTime()); 
...
function sendRequest2(example_runid) { 
  ...
  http.open('get', 'http://localhost:55555/cgi-bin/exampleWebGL.cgi?myrunid=' + example_runid + '&myDat=' + example_runid + '&myfunc=vertices&nocache='+now.getTime()); 
  //http.open('get', 'http://localhost:55555/cgi-bin/ajaxdemo.cgi'); 
...
function sendRequest3(example_runid) { 
  ...
  //http.open('get', 'http://www.myhostname.com/cgi-bin/myscript.pl?nocache='+now.getTime()); 
  //http.open('get', 'http://localhost:55555/cgi-bin/ajaxdemo.cgi?nocache='+now.getTime()); 
  //alert('sendRequest3 example_runid=' + example_runid);
  myRunID = document.getElementById("examplerunid").innerHTML;
  alert('sendRequest3: myRunID=' + myRunID + ' myDat=' + example_runid);
  http.open('get', 'http://localhost:55555/cgi-bin/exampleWebGL.cgi?myrunid=' + example_runid + '&myDat=' + example_runid + '&myfunc=faces&nocache='+now.getTime()); 
    ...
    if(response) { // UPDATE ajaxTest content 
     ...
     alert('Response1:' + response);
      ...
      for (var i = 1; i < jsonData.length; i++) { // Start with 1 to skip the output directory name
        ...
        var radioBtn = $('<input type="radio" name="myradioInput" value="'
				+ jsonData[i] + ' />');
        radioBtn.appendTo('#newexampleForm2');

        // $( "#newexampleForm2" ).append($(option));
...
function handleResponse2() { 
  if(http.readyState == 4 && http.status == 200){ 
    ...
    //$( "#mybutton2" ).value("Display Output");
	document.getElementById("mybutton2").value  = "Display Output";
...
function handleResponse3() { 
  if(http.readyState == 4 && http.status == 200){ 
    ...
    if(response) { // UPDATE ajaxTest content 
      ...
      //setTimeout('wipeout()', 2000); // wait 2 seconds, then clear message
      //var jsonData = eval ("(" + txt + ")");
      alert("handleResponse3 DOjsonData Faces" + faces);
