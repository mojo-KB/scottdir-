...
if ( $myFunc eq "execexample") {
  ...
  # for input data directory from user
  # if ($instring =~ m/;/){ die "look out"};
  # Link the data files to this directory
  `ln -s /home/faculty/scott/www/cgi-bin/DATA/mydata.dat .`;
  `ln -s /home/faculty/scott/www/cgi-bin/DATA/mydata.dat mydata2.dat`;
  `ln -s /home/faculty/scott/www/cgi-bin/DATA/mydata.dat mydata3.dat`;

   #`/home/faculty/scott/www/cgi-bin/TEC360/prog TEC360_inputs.inp >& myOutput`;
...
print DEBUGOUT "JSON IS: $utf8_encoded_json_dirname";
...
# simple and fast interfaces (expect/generate UTF-8)
 ...
 use lib '/home/faculty/scott/www/cgi-bin/JSON-2.90';
 use lib '/home/faculty/scott/www/cgi-bin/JSON-2.90/lib';
 use lib::JSON; 
 use JSON::backportPP; 
...
# DON'T FORGET THAT $#newarray is the index of the last element,
# IT IS NOT THE NUMBER OF ELEMENTS, so need <= here. It was not
# processing the last face. Scott 3/22/2017
while ($cnt <= $#newarray) {
...
if ( $myFunc eq "faces") {
 #chdir $myRunid;
 chdir "/home/faculty/scott/www/cgi-bin/DATA";
 doMyParse();
 #print "FACES: ";
 #print @jsonFaces;
 #exit;
...
print DEBUGOUT "\n myFunc=$myFunc myRunid=$myRunid myDat=$myDat \n";
 #chdir $myRunid;
print DEBUGOUT "call doMyParse 1 vertices";
 chdir "/home/faculty/scott/www/cgi-bin/DATA";
print DEBUGOUT "call doMyParse 2 vertices";
my $thisls=`ls`;
print DEBUGOUT "ls of DATA vertices $thisls";
 doMyParse();
