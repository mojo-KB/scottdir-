...
$expires = sprintf "%d-%s-%d %d:%d:%d", 
	$mday,$monthname[$mon],"1999",$hour,$min,$sec;
print << "HTMLHEAD"; 
Content-type: text/html

<head>
<META HTTP-EQUIV="Set-Cookie" content="newcookie=$oval; expires=$expires GMT">
<META HTTP-EQUIV="Set-Cookie" content="newcookie2=11111111; expires=$expires GMT">
<!-- <META HTTP-EQUIV="Set-Cookie" content="newcookie2=SSPETKA&\; expires=$expires GMT"> -->
